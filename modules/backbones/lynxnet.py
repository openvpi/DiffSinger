...
from modules.commons.common_layers import SinusoidalPosEmb, SwiGLU, Transpose, AdamWCovn1d
...
class LYNXNet(nn.Module):
    def __init__(self, in_dims, n_feats, *, num_layers=6, num_channels=512, expansion_factor=2, kernel_size=31,
        ...
        self.output_projection = AdamWCovn1d(num_channels, in_dims * n_feats, kernel_size=1)
